...
NUM_GPUS=${3-1}
VRAM_PER_GPU=${4-40g}
echo "Selected configuration: configs/flava/wit_resume_model_2.yaml, GPUs: $NUM_GPUS, $VRAM_PER_GPU VRAM/GPU, resuming run $RESUME_ID (ID) in group '$WANDB_RUN_GROUP'"
